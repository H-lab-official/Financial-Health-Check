...
export const NavBar = () => {
    ...
    const isCongratulationsPath = location.pathname === '/congratulations';
    ...
    return (
        <div className='flex flex-row justify-between items-center py-4 w-[400px] px-4 bg-white mb-2'>
            ...
            <button
                ...
                className={`border flex flex-row justify-center items-center rounded-full w-[200px] h-8 gap-1 ${isCongratulationsPath ? 'bg-[#0E2B81] text-white' : 'border-[#0E2B81]'}`}
            >
